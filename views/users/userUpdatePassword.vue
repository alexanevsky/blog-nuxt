<template>
  <LayoutContainer>
    <template #breadcrumbs>
      ...
      <LayoutBreadcrumb name="users.titles.updatePassword" :to="{name: 'userUpdatePassword', params: {id: user.alias || user.id}}" :active="true" />
    </template>
    ...
    <LayoutContainerWrapper>
      ...
      <LayoutContainerMain>
        <AppUserEditPassword :user="user" @form-handled="formHandled()" />
      </LayoutContainerMain>
    </LayoutContainerWrapper>
  </LayoutContainer>
</template>
